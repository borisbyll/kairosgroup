...
const handleSubmit = async (e) => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex flex-col md:flex-row font-['Poppins'] text-slate-900flex h-screen bg-slate-50 overflow-hidden">
        ...
        {activeMenu === 'stats' && (
          <div className="space-y-10 animate-in fade-in duration-500">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl border border-slate-100 shadow-sm flex items-center justify-between"><div><p className="text-[9px] font-bold text-slate-500 uppercase mb-1">Valeur Parc</p><p style={{ color: primaryColor }} className="text-2xl font-bold">{totalValue.toLocaleString()} {siteConfig.features.currency}</p></div></div>
