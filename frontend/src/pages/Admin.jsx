...
const Admin = () => {
  ...
  return (
    // FIX : On applique h-screen et overflow-hidden UNIQUEMENT sur le parent pour isoler les scrolls
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      
      {/* SIDEBAR : On s'assure qu'elle prend toute la hauteur et qu'elle a son scroll indépendant */}
      <aside className={`
      ...
      `}>
        ...
        {/* Navigation défilante à l'intérieur de la sidebar */}
      ...
      {/* ZONE PRINCIPALE : Elle défile indépendamment */}
